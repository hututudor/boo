...
<html lang="en">
  ...
  <head>
    ...
    <title>Search results | Boo</title>
    ...
    <meta name="page-name" content="books_search" />
  ...
  <body>
    ...
    <main>
      <div class="text text__32 text__bold mb-4">All books matching "<span id="query-display"></span>"</div>
      <div class="books">
        <div class="text text__20">No results</div>
      </div>
    </main>
  </body>
</html>
